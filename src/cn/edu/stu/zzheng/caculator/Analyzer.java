package cn.edu.stu.zzheng.caculator;

import cn.edu.stu.zzheng.grammar.*;

/**
 * Created by neng-zheng on 2015/12/24.
 */
public class Analyzer {
    ...
    public void analy(){
        ...
        while (true){
            ...
            }else if (o[terminators.getTerByValue(s[j]).getId()][terminators.getTerByValue(current).getId()].equals("<")){
                action=0;
                print();
                k=k+1;
                s[k]=current;
    ...
    public void print(){
        ...
        System.out.println(" "+num+space(6-String.valueOf(num).length())+ss+space(11-ss.length())+current+space(15-input.length())+input+space(6)+action(action));
